...
class AusbildungApi
{
    ...
    protected function getAusbildungenVonAusbildungsgangUsingGETRequest($id)
    {
        ...
        $resourcePath = '/v2/ausbildungszuege/{id}/ausbildungen';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function lekBearbeitetUsingPOSTRequest($ausbildungszugabschnitt_id, $teilnehmer_id, $lek_bearbeitet_api_dto = null)
    {
        ...
        $resourcePath = '/v2/ausbildungszugabschnitte/{ausbildungszugabschnittId}/teilnehmer/{teilnehmerId}/lekBearbeitet';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function lekFreischaltenUsingPOSTRequest($ausbildungszugabschnitt_id, $teilnehmer_id, $lek_freischalten_api_dto = null)
    {
        ...
        $resourcePath = '/v2/ausbildungszugabschnitte/{ausbildungszugabschnittId}/teilnehmer/{teilnehmerId}/lekFreischalten';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function lernfristStartenUsingPOSTRequest($ausbildungszugabschnitt_id, $teilnehmer_id, $lernfrist_starten_api_dto = null)
    {
        ...
        $resourcePath = '/v2/ausbildungszugabschnitte/{ausbildungszugabschnittId}/teilnehmer/{teilnehmerId}/lernfristStarten';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
