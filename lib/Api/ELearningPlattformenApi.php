...
class ELearningPlattformenApi
{
     ...
     * @return void
     */
    public function meldeElearningaccountAnlageAlsFehlgeschlagenUsingPOST($plattform_id, $teilnehmer_id, $fehlermeldung_api_dto = null)
    {
        $this->meldeElearningaccountAnlageAlsFehlgeschlagenUsingPOSTWithHttpInfo($plattform_id, $teilnehmer_id, $fehlermeldung_api_dto);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function meldeElearningaccountAnlageAlsFehlgeschlagenUsingPOSTWithHttpInfo($plattform_id, $teilnehmer_id, $fehlermeldung_api_dto = null)
    {
        $returnType = '';
        $request = $this->meldeElearningaccountAnlageAlsFehlgeschlagenUsingPOSTRequest($plattform_id, $teilnehmer_id, $fehlermeldung_api_dto);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function meldeElearningaccountAnlageAlsFehlgeschlagenUsingPOSTAsync($plattform_id, $teilnehmer_id, $fehlermeldung_api_dto = null)
    {
        return $this->meldeElearningaccountAnlageAlsFehlgeschlagenUsingPOSTAsyncWithHttpInfo($plattform_id, $teilnehmer_id, $fehlermeldung_api_dto)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function meldeElearningaccountAnlageAlsFehlgeschlagenUsingPOSTAsyncWithHttpInfo($plattform_id, $teilnehmer_id, $fehlermeldung_api_dto = null)
    {
        $returnType = '';
        $request = $this->meldeElearningaccountAnlageAlsFehlgeschlagenUsingPOSTRequest($plattform_id, $teilnehmer_id, $fehlermeldung_api_dto);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function meldeElearningaccountAnlageAlsFehlgeschlagenUsingPOSTRequest($plattform_id, $teilnehmer_id, $fehlermeldung_api_dto = null)
    {
        // verify the required parameter 'plattform_id' is set
        if ($plattform_id === null || (is_array($plattform_id) && count($plattform_id) === 0)) {
            throw new \InvalidArgumentException(
