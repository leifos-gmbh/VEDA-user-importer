...
class AusbildungszugabschnitteApi
{
    ...
    /**
     * Operation lernerfolgMeldenUsingPUT
     *
     ...
     * @param  \Swagger\Client\Model\LernerfolgMeldenApiDto $lernerfolg_melden_api_dto Details zum Lernerfolg. (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function lernerfolgMeldenUsingPUT($ausbildungszugabschnitt_id, $teilnehmer_id, $lernerfolg_melden_api_dto = null)
    {
        $this->lernerfolgMeldenUsingPUTWithHttpInfo($ausbildungszugabschnitt_id, $teilnehmer_id, $lernerfolg_melden_api_dto);
    }

    /**
     * Operation lernerfolgMeldenUsingPUTWithHttpInfo
     *
     * Ermöglicht es, den Lernerfolg eines Ausbildungszugabschnitts für den angegebenen Teilnehmer zu melden
     *
     * @param  string $ausbildungszugabschnitt_id ID des Ausbildungszugabschnitts (required)
     ...
     */
    public function lernerfolgMeldenUsingPUTWithHttpInfo($ausbildungszugabschnitt_id, $teilnehmer_id, $lernerfolg_melden_api_dto = null)
    {
        $returnType = '';
        $request = $this->lernerfolgMeldenUsingPUTRequest($ausbildungszugabschnitt_id, $teilnehmer_id, $lernerfolg_melden_api_dto);
    ...
    /**
     * Operation lernerfolgMeldenUsingPUTAsync
     *
     * Ermöglicht es, den Lernerfolg eines Ausbildungszugabschnitts für den angegebenen Teilnehmer zu melden
     *
     * @param  string $ausbildungszugabschnitt_id ID des Ausbildungszugabschnitts (required)
     ...
     */
    public function lernerfolgMeldenUsingPUTAsync($ausbildungszugabschnitt_id, $teilnehmer_id, $lernerfolg_melden_api_dto = null)
    {
        return $this->lernerfolgMeldenUsingPUTAsyncWithHttpInfo($ausbildungszugabschnitt_id, $teilnehmer_id, $lernerfolg_melden_api_dto)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation lernerfolgMeldenUsingPUTAsyncWithHttpInfo
     *
     * Ermöglicht es, den Lernerfolg eines Ausbildungszugabschnitts für den angegebenen Teilnehmer zu melden
     *
     * @param  string $ausbildungszugabschnitt_id ID des Ausbildungszugabschnitts (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function lernerfolgMeldenUsingPUTAsyncWithHttpInfo($ausbildungszugabschnitt_id, $teilnehmer_id, $lernerfolg_melden_api_dto = null)
    {
        $returnType = '';
        $request = $this->lernerfolgMeldenUsingPUTRequest($ausbildungszugabschnitt_id, $teilnehmer_id, $lernerfolg_melden_api_dto);
    ...
    /**
     * Create request for operation 'lernerfolgMeldenUsingPUT'
     *
     * @param  string $ausbildungszugabschnitt_id ID des Ausbildungszugabschnitts (required)
     * @param  string $teilnehmer_id ID des Teilnehmers (required)
     * @param  \Swagger\Client\Model\LernerfolgMeldenApiDto $lernerfolg_melden_api_dto Details zum Lernerfolg. (optional)
     ...
     */
    protected function lernerfolgMeldenUsingPUTRequest($ausbildungszugabschnitt_id, $teilnehmer_id, $lernerfolg_melden_api_dto = null)
    {
        ...
        if ($ausbildungszugabschnitt_id === null || (is_array($ausbildungszugabschnitt_id) && count($ausbildungszugabschnitt_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ausbildungszugabschnitt_id when calling lernerfolgMeldenUsingPUT'
            );
        }
        // verify the required parameter 'teilnehmer_id' is set
        if ($teilnehmer_id === null || (is_array($teilnehmer_id) && count($teilnehmer_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $teilnehmer_id when calling lernerfolgMeldenUsingPUT'
            );
        }
    ...
    /**
     * Operation meldeKorrigierterPraktikumsberichtUsingPUT
     *
     * Ermöglicht es, den geprüften Praktikumsbericht für den angegebenen Teilnehmer zu melden
     *
     * @param  string $ausbildungszugabschnitt_id ID des Ausbildungszugabschnitts (required)
     * @param  string $teilnehmer_id ID des Teilnehmers (required)
     * @param  \Swagger\Client\Model\KorrigierterPraktikumsberichtApiDto $praktikumsbericht_eingegangen_api_dto Details zum Lernerfolg. (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function meldeKorrigierterPraktikumsberichtUsingPUT($ausbildungszugabschnitt_id, $teilnehmer_id, $praktikumsbericht_eingegangen_api_dto = null)
    {
        $this->meldeKorrigierterPraktikumsberichtUsingPUTWithHttpInfo($ausbildungszugabschnitt_id, $teilnehmer_id, $praktikumsbericht_eingegangen_api_dto);
    }

    /**
     * Operation meldeKorrigierterPraktikumsberichtUsingPUTWithHttpInfo
     *
     * Ermöglicht es, den geprüften Praktikumsbericht für den angegebenen Teilnehmer zu melden
     *
     * @param  string $ausbildungszugabschnitt_id ID des Ausbildungszugabschnitts (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function meldeKorrigierterPraktikumsberichtUsingPUTWithHttpInfo($ausbildungszugabschnitt_id, $teilnehmer_id, $praktikumsbericht_eingegangen_api_dto = null)
    {
        $returnType = '';
        $request = $this->meldeKorrigierterPraktikumsberichtUsingPUTRequest($ausbildungszugabschnitt_id, $teilnehmer_id, $praktikumsbericht_eingegangen_api_dto);
    ...
    /**
     * Operation meldeKorrigierterPraktikumsberichtUsingPUTAsync
     *
     * Ermöglicht es, den geprüften Praktikumsbericht für den angegebenen Teilnehmer zu melden
     *
     * @param  string $ausbildungszugabschnitt_id ID des Ausbildungszugabschnitts (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function meldeKorrigierterPraktikumsberichtUsingPUTAsync($ausbildungszugabschnitt_id, $teilnehmer_id, $praktikumsbericht_eingegangen_api_dto = null)
    {
        return $this->meldeKorrigierterPraktikumsberichtUsingPUTAsyncWithHttpInfo($ausbildungszugabschnitt_id, $teilnehmer_id, $praktikumsbericht_eingegangen_api_dto)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation meldeKorrigierterPraktikumsberichtUsingPUTAsyncWithHttpInfo
     *
     * Ermöglicht es, den geprüften Praktikumsbericht für den angegebenen Teilnehmer zu melden
     *
     * @param  string $ausbildungszugabschnitt_id ID des Ausbildungszugabschnitts (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function meldeKorrigierterPraktikumsberichtUsingPUTAsyncWithHttpInfo($ausbildungszugabschnitt_id, $teilnehmer_id, $praktikumsbericht_eingegangen_api_dto = null)
    {
        $returnType = '';
        $request = $this->meldeKorrigierterPraktikumsberichtUsingPUTRequest($ausbildungszugabschnitt_id, $teilnehmer_id, $praktikumsbericht_eingegangen_api_dto);
    ...
    /**
     * Create request for operation 'meldeKorrigierterPraktikumsberichtUsingPUT'
     *
     * @param  string $ausbildungszugabschnitt_id ID des Ausbildungszugabschnitts (required)
     * @param  string $teilnehmer_id ID des Teilnehmers (required)
     * @param  \Swagger\Client\Model\KorrigierterPraktikumsberichtApiDto $praktikumsbericht_eingegangen_api_dto Details zum Lernerfolg. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function meldeKorrigierterPraktikumsberichtUsingPUTRequest($ausbildungszugabschnitt_id, $teilnehmer_id, $praktikumsbericht_eingegangen_api_dto = null)
    {
        // verify the required parameter 'ausbildungszugabschnitt_id' is set
        if ($ausbildungszugabschnitt_id === null || (is_array($ausbildungszugabschnitt_id) && count($ausbildungszugabschnitt_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ausbildungszugabschnitt_id when calling meldeKorrigierterPraktikumsberichtUsingPUT'
            );
        }
        // verify the required parameter 'teilnehmer_id' is set
        if ($teilnehmer_id === null || (is_array($teilnehmer_id) && count($teilnehmer_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $teilnehmer_id when calling meldeKorrigierterPraktikumsberichtUsingPUT'
            );
        }
