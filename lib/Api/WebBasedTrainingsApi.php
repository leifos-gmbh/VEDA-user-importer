...
class WebBasedTrainingsApi
{
     ...
     *
     * @param  \DateTime $modifiziert_ab Änderungs- bzw. Einfügezeitpunkt, ab dem die Web Based Trainings geliefert werden sollen. Das Format muss wie folgt sein: yyyy-MM-dd&#39;T&#39;HH:mm:ss.sss (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\WebBasedTraining[]
     */
    public function getWebBasedTrainingsUsingGET($modifiziert_ab = null)
    {
        list($response) = $this->getWebBasedTrainingsUsingGETWithHttpInfo($modifiziert_ab);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\WebBasedTraining[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getWebBasedTrainingsUsingGETWithHttpInfo($modifiziert_ab = null)
    {
        $returnType = '\Swagger\Client\Model\WebBasedTraining[]';
        $request = $this->getWebBasedTrainingsUsingGETRequest($modifiziert_ab);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWebBasedTrainingsUsingGETAsync($modifiziert_ab = null)
    {
        return $this->getWebBasedTrainingsUsingGETAsyncWithHttpInfo($modifiziert_ab)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWebBasedTrainingsUsingGETAsyncWithHttpInfo($modifiziert_ab = null)
    {
        $returnType = '\Swagger\Client\Model\WebBasedTraining[]';
        $request = $this->getWebBasedTrainingsUsingGETRequest($modifiziert_ab);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getWebBasedTrainingsUsingGETRequest($modifiziert_ab = null)
    {
