...
class VeranstaltungstypenApi
{
     ...
     */
    public function getAllePraesenzVirtuellVeranstaltungstypenUsingGET()
    {
        list($response) = $this->getAllePraesenzVirtuellVeranstaltungstypenUsingGETWithHttpInfo();
        return $response;
    }
     ...
     */
    public function getAllePraesenzVirtuellVeranstaltungstypenUsingGETWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\Veranstaltungstyp[]';
        $request = $this->getAllePraesenzVirtuellVeranstaltungstypenUsingGETRequest();
     ...
     */
    public function getAllePraesenzVirtuellVeranstaltungstypenUsingGETAsync()
    {
        return $this->getAllePraesenzVirtuellVeranstaltungstypenUsingGETAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllePraesenzVirtuellVeranstaltungstypenUsingGETAsyncWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\Veranstaltungstyp[]';
        $request = $this->getAllePraesenzVirtuellVeranstaltungstypenUsingGETRequest();
     ...
     */
    protected function getAllePraesenzVirtuellVeranstaltungstypenUsingGETRequest()
    {
