 ...
 */
class PraktikumsberichtKorrigiertApiDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PraktikumsberichtKorrigiertApiDto';
    ...
    protected static array $openAPINullables = [
        'praktikumsbericht_korrigiert' => false,
		'praktikumsbericht_korrigiert_am' => false
    ];
    ...
    {
        $this->setIfExists('praktikumsbericht_korrigiert', $data ?? [], null);
        $this->setIfExists('praktikumsbericht_korrigiert_am', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($praktikumsbericht_korrigiert)) {
            throw new \InvalidArgumentException('non-nullable praktikumsbericht_korrigiert cannot be null');
        }
     ...
     *
     * @param \DateTime|null $praktikumsbericht_korrigiert_am Optionales Datum, wann der Praktikumsbericht korrigiert worden ist.
     *
     * @return self
     */
    public function setPraktikumsberichtKorrigiertAm($praktikumsbericht_korrigiert_am)
    {
        if (is_null($praktikumsbericht_korrigiert_am)) {
            throw new \InvalidArgumentException('non-nullable praktikumsbericht_korrigiert_am cannot be null');
        }
