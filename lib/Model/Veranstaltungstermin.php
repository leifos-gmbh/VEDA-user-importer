...
class Veranstaltungstermin implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string $veranstaltungstyp_id Die ID des Veranstaltungstyps des Veranstaltungstermins. Ist die ID gesetzt so wird zusätlich ein Link auf den Veranstaltungstypen geliefert.
     *
     * @return $this
     */
