 ...
 */
class Ausbildungszugabschnitt implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Ausbildungszugabschnitt';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('bearbeitungsende', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($ausbildungsgangabschnitt_id)) {
            throw new \InvalidArgumentException('non-nullable ausbildungsgangabschnitt_id cannot be null');
        }
     ...
     *
     * @param \DateTime|null $bearbeitungsende Der optionale Zeitpunkt, wann die Bearbeitungszeit für die dem Teilnehmer auferlegten Aufgaben endet.
     *
     * @return self
     */
    public function setBearbeitungsende($bearbeitungsende)
    {
        if (is_null($bearbeitungsende)) {
            throw new \InvalidArgumentException('non-nullable bearbeitungsende cannot be null');
        }
     ...
     * Sets beginn
     *
     * @param \DateTime|null $beginn Der Beginn-Zeitpunkt des Ausbildungszugabschnitt
     *
     * @return self
     */
     ...
     * Sets ende
     *
     * @param \DateTime|null $ende Der Ende-Zeitpunkt des Ausbildungszugabschnitt
     *
     * @return self
     */
