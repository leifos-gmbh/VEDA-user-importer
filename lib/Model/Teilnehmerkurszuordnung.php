 ...
 */
class Teilnehmerkurszuordnung implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Teilnehmerkurszuordnung';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('teilnehmerbuchung_id', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($teilnehmerbuchung_id)) {
            throw new \InvalidArgumentException('non-nullable teilnehmerbuchung_id cannot be null');
        }
