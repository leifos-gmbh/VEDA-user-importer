 ...
 */
class Dozentenkurszuordnung implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Dozentenkurszuordnung';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('dozentenbuchung_id', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($dozentenbuchung_id)) {
            throw new \InvalidArgumentException('non-nullable dozentenbuchung_id cannot be null');
        }
