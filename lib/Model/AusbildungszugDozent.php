 ...
 */
class AusbildungszugDozent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AusbildungszugDozent';
    ...
    {
        $this->setIfExists('dozent_id', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($dozent_id)) {
            throw new \InvalidArgumentException('non-nullable dozent_id cannot be null');
        }
     ...
     *
     * @param \DateTime|null $kurs_zugriff_ab Datum ab dem der Dozent auf den Termin zugreifen darf
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $kurs_zugriff_bis Datum bis zu dem der Dozent auf den Termin zugreifen darf
     *
     * @return self
     */
