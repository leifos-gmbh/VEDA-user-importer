 ...
 */
class FehlermeldungApiDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FehlermeldungApiDto';
    ...
    {
        $this->setIfExists('fehlermeldung', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets fehlermeldung
     *
     * @param string|null $fehlermeldung Der Text der Fehlermeldung.
     *
     * @return self
     */
    public function setFehlermeldung($fehlermeldung)
    {
        if (is_null($fehlermeldung)) {
            throw new \InvalidArgumentException('non-nullable fehlermeldung cannot be null');
        }
