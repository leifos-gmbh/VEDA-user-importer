...
/**
 * KursbearbeitungDto Class Doc Comment
 *
 * @category Class
 * @description Der Zeitstempel für die Rückmeldung zu einer Kursbearbeitung.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class KursbearbeitungDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'KursbearbeitungDto';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('zeitstempel', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['zeitstempel'];
    }

    /**
     * Sets zeitstempel
     *
     * @param \DateTime|null $zeitstempel Der Zeitstempel
     *
     * @return self
     */
    public function setZeitstempel($zeitstempel)
    {
        if (is_null($zeitstempel)) {
            throw new \InvalidArgumentException('non-nullable zeitstempel cannot be null');
        }
        $this->container['zeitstempel'] = $zeitstempel;
