...
class VeranstaltungstypSuche implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const VERANSTALTUNGSART_WBT = 'WBT';
    public const VERANSTALTUNGSART_FERNLEHRGANG = 'FERNLEHRGANG';
    ...
    public function getVeranstaltungsartAllowableValues()
    {
        return [
            ...
            self::VERANSTALTUNGSART_WBT,
            self::VERANSTALTUNGSART_FERNLEHRGANG,
        ];
    }
