...
class OrganisationenApi
{
     ...
     */
    public function getOrganisationUsingGET($organisation_id)
    {
        list($response) = $this->getOrganisationUsingGETWithHttpInfo($organisation_id);
        return $response;
    }
     ...
     */
    public function getOrganisationUsingGETWithHttpInfo($organisation_id)
    {
        $returnType = '\Swagger\Client\Model\Organisation';
        $request = $this->getOrganisationUsingGETRequest($organisation_id);
     ...
     */
    public function getOrganisationUsingGETAsync($organisation_id)
    {
        return $this->getOrganisationUsingGETAsyncWithHttpInfo($organisation_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrganisationUsingGETAsyncWithHttpInfo($organisation_id)
    {
        $returnType = '\Swagger\Client\Model\Organisation';
        $request = $this->getOrganisationUsingGETRequest($organisation_id);
     ...
     */
    protected function getOrganisationUsingGETRequest($organisation_id)
    {
